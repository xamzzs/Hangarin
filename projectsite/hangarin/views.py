...
class TaskListView(ListView):
    ...
    def get_queryset(self):
        return Task.objects.select_related('category', 'priority').order_by('-created_at')
...
class SubTaskCreateView(CreateView):
    ...
    def get_success_url(self):
        return reverse('task-detail', kwargs={'pk': self.parent_task.pk})
...
class SubTaskUpdateView(UpdateView):
    ...
    def get_success_url(self):
        return reverse('task-detail', kwargs={'pk': self.object.parent_task.pk})
...
class PriorityListView(ListView):
    ...
    def get_queryset(self):
        return Priority.objects.all().order_by('name')
